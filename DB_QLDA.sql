...
FROM NhanVien INNER JOIN PhanCong ON NhanVien.MaNV=PhanCong.MaNV INNER JOIN DeAn ON PhanCong.MaDA=DeAn.MaDA JOIN PhongBan ON NhanVien.Phong=PhongBan.TenPB
WHERE TenPB='Nguyen Cuu'
AND TenDA='Tin hoc hoa'
AND ThoiGian='20'

--Cau 9
SELECT DISTINCT TrPHG
FROM PhongBan INNER JOIN DeAn ON PhongBan